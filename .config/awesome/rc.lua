...
mytextclock = awful.widget.textclock({ align = "left" }, "%a %b %d, %H:%M:%S", 1)

mymem = widget({ type = "textbox" })
vicious.register(mymem, vicious.widgets.mem, "$1% ", 2)

mycpu = widget({ type = "textbox" })
vicious.register(mycpu, vicious.widgets.cpu, "$1% | ", 2)

mybat = widget({ type = "textbox" })
vicious.register(mybat, vicious.widgets.bat, " | $2$1", 2, "BAT1")
...
globalkeys = awful.util.table.join(
    ...
    -- Suspend shortcuts
    awful.key({ modkey , "Control", "Shift"}, "Escape", function () awful.util.spawn("/usr/sbin/s2disk"  ) end)
)
